...
$id = $_GET['id'];
$read = new Read();
$pharmacie = $read->getOnePharmacie($id);
?>
...
<div class="container-fluid">
    ...
    <div class="jumbotron text-center" style="background-color: #5cb85c">
        <h1 class="display-4" style="height: 30px">
            <strong><?php echo $pharmacie[0]['nom'] ?></strong>
    </div>

    <!-- Etat des données -->
    <div id="div0" class="alert alert-info text-center" role="alert" style="display: block"><strong>Données de
            la pharmacie</strong></div>
    ...
    <div id="div4" class="alert alert-danger text-center" role="alert" style="display: none"><strong>Pharmacie
            ...
            <div class="form-group row">
                ...
                <div class="col-6">
                    <input type="text" class="form-control" id="nom"
                           value="<?php echo $pharmacie[0]['nom'] ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-6">
                    <input type="text" class="form-control" id="adresse"
                           value="<?php echo $pharmacie[0]['adresse'] ?>">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-6">
                    <input type="text" class="form-control" id="ville"
                           value="<?php echo $pharmacie[0]['ville'] ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-6">
                    <input type="text" class="form-control" id="telephone"
                           value="<?php echo $pharmacie[0]['telephone'] ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-6">
                    <input type="text" class="form-control" id="mail"
                           value="<?php echo $pharmacie[0]['mail'] ?>">
                </div>
            </div>

            <div class="modal-footer">
                <a href="listePharmacie.php" class="btn btn-secondary" role="button"
                   aria-pressed="true">Retour</a>
                <button type="button" class="btn btn-success" onclick="SauvegarderPharmacie()">
                    Sauvegarder
                </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Confirmez-vous la suppression de
                        <strong><?php echo $pharmacie[0]['nom'] ?></strong></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Quitter</button>
                    <button type="button" class="btn btn-danger" onclick="SupprimerPharmacie()">Supprimer</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    function SauvegarderPharmacie() {
        event.preventDefault();
        $.ajax({
            method: "POST",
            url: "../../Controller/Pharmacie/UpdatePharmacieController.php",
            dataType: "json",
            data:
                {
    ...
    function SupprimerPharmacie() {
        event.preventDefault();
        $.ajax({
            method: "POST",
            url: "../../Controller/Pharmacie/SupprimerPharmacieController.php",
            dataType: "json",
            data:
                {
                    'id': <?php echo $id ?>
