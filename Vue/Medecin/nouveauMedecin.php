...
<div class="container-fluid">
    ...
    <div id="div0" class="alert alert-info text-center" role="alert" style="display: block"><strong>En attente de
            données</strong></div>
    <div id="div1" class="alert alert-success text-center" role="alert" style="display: none"><strong>Médecin
    ...
    <div id="div3" class="alert alert-warning text-center" role="alert" style="display: none"><strong>Aucune donnée
            renseigné, médecin non créé</strong></div>
    ...
    <div class="modal-footer">
        <a href="listeMedecin.php" class="btn btn-secondary" role="button" aria-pressed="true">Retour</a>
        </button>
    ...
    jQuery(function () {
        ...
        $("#enregistrerButton").on('click', function () {
            ...
            if ($("#nom").val() !== "") {
                $.ajax({
                    method: "POST",
                    url: "../../Controller/Medecin/EnregistrerMedecinController.php",
                    dataType: "json",
                    data:
                        {
                            'nom': $("#nom").val(),
