...
if (isset ($_POST ['nom']) && isset ($_POST ['prenom']) && isset ($_POST ['sexe']) && isset ($_POST ['naissance']) && isset ($_POST ['adresse'])
...
$create = new Create();
$ok = $create->CreerPatient($_POST ['nom'], $_POST ['prenom'], $_POST ['sexe'], $_POST ['naissance'], $_POST ['adresse'], $_POST ['cp'], $_POST ['ville'], $_POST ['telephone'],
